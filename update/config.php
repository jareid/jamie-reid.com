<?php
    ...
    // Name of the database
     ...
     if($whereami == "dev.jamie-reid.com"){
        define( 'K_DB_NAME', 'devcouchcms' );
    } else {
    ...
    // 6.
    // Database password
    define( 'K_DB_PASSWORD', 'couchcmsforthewin' );
    // 7.
    ...
    define( 'K_PAYPAL_EMAIL', 'jamie.reid@gmx.com' );
    // 19.
